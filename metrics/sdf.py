...
def compute_chamfer(mesh_path_gt, mesh_path_pred, config):
    try:
        ...
        print(f"Calculate CD for {mesh_path_pred} failed")
        return -1
...
def compute_metro(mesh_path_gt, mesh_path_pred, config):
    try:
        ...
        print(f"Calculate Metro for {mesh_path_pred} failed")
        return -1
...
def compute_f_score(mesh_path_gt, mesh_path_pred, config):
    try:
        ...
        print(f"Calculate F-Score for {mesh_path_pred} failed")
        return -1
...
def compute_iou(mesh_path_gt, mesh_path_pred, scale, normalize):
    try:
        ...
        print(f"Calculate IoU for {mesh_path_pred} failed")
        return -1
